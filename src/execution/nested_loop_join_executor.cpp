...
START:
  ...
  bool generate_for_unmatched = false;
...
void NestedLoopJoinExecutor::AddTupleValuesTo(std::vector<Value> &values, Tuple *tuple, const Schema &schema){
